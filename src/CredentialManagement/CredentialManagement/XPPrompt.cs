...
namespace CredentialManagement
{
	public class XPPrompt : BaseCredentialsPrompt
	{
		...
		public bool CompleteUsername
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x800 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public bool ExpectConfirmation
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x20000 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public bool Persist
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x1000 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public bool RequireCertificate
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x10 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public bool RequireSmartCard
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x100 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public bool UsernameReadOnly
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x100000 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public bool ValidateUsername
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x400 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public override bool ShowSaveCheckBox
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x40 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public override bool GenericCredentials
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x40000 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
		...
		public bool AlwaysShowUI
		{
			...
			{
				CheckNotDisposed();
				return 0 != (0x80 & base.DialogFlags);
			}
			set
			{
				CheckNotDisposed();
